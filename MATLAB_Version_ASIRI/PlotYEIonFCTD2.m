...
comp_2_plot1 = nanmedfilt1(comp,5,[],1);
...
delete(h)
hold on;
h = polar(atan2(comp(:,2),comp(:,1)),ones(size(comp,1),1));
hold on;
h1 = compass(comp_2_plot1(end,1),comp_2_plot1(end,2),'b');
hold off
set(h,'color','b','marker','*','markersize',2,'markeredgecolor','b','linestyle','none');
set(gca,'yTicklabel',{});
get(gca,'yTicklabel')
...
plot(comp_2_plot1(:,1),comp_2_plot1(:,2)/0.4,'b*','markersize',2);
hold on;
plot3(gyro(:,1)/3,gyro(:,2)/3,gyro(:,3)/3,'r*','markersize',2);
plot3(acceleration(:,1)/1,acceleration(:,2)/1,acceleration(:,3)/1,'g*','markersize',2);

disp(size(comp_2_plot1))
disp(size(Comp_2_plot1))

% quiver3(0,0,0,comp(end,1)/0.4,comp(end,2)/0.4,comp(end,3)/0.4,0,'color','b','linewidth',5);
quiver(0,0,comp_2_plot1(end,1),comp_2_plot1(end,2),0,'color','b','linewidth',5);
% quiver3(0,0,0,comp_2_plot1(1),comp_2_plot1(2),comp_2_plot1(3),0,'color','b','linewidth',5);
